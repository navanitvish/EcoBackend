...
// Admin: Update payment status manually (emergency use)
router.patch('/admin/payment/:transactionId',
  authenticateToken,
  requireAdmin,
  async (req, res) => {
    try {
...
// Admin: Retry failed payment - FIXED VERSION
router.post('/admin/retry/:transactionId',
  authenticateToken,
  requireAdmin,
  async (req, res) => {
    try {
      ...
      // Forward the request to checkPaymentStatus
